...
module.exports = async (req, res) => {
  try { 
    const url = 'https://toolbaz.com/image/ai-image-generator'; const response = await axios.get(url, { headers: { 'User-Agent': 'Mozilla/5.0 (Linux; Android 10; RMX2185 Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.6998.40 Mobile Safari/537.36', 'Referer': 'https://toolbaz.com/image/ai-image-generator' } });
